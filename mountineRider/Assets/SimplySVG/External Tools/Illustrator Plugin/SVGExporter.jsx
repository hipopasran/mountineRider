...
// Version n0.7 Removed other than svg formats and made svg saving options automaticly match to Simply SVG's needs
//
...
getSvgOptions = function ( embedImage, embedFont, trimEdges ) {
	options = new ExportOptionsSVG();
	options.embedRasterImages = embedImage;
	options.documentEncoding = SVGDocumentEncoding.UTF8;
	options.cssProperties = SVGCSSPropertyLocation.PRESENTATIONATTRIBUTES; //ENTITIES;
	return options;
}
...
var multi_exporter = {
	...
	controlNames:["embedImageCheckBox","embedFontCheckBox","trimEdgesCheckBox","innerPaddingCheckBox"],
	...
	formatInfo: [{name:"SVG", copyBehaviour:true, pixelDocSize:false, getOptions:getSvgOptions, saveFile:saveSvg, activeControls:["embedImageCheckBox","trimEdgesCheckBox"]}],
	...
	checkFormat: function ( progLabel ) {
		var formatInfo = this.formatInfo[0];
	...
	run_export: function() {
		...
		var num_exported = 0;
		var options = formatInfo.getOptions(this.embedImage, this.embedFont, this.trimEdges);
